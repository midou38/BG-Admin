...
public class InKitchenOrderFragment extends Fragment {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (ordersRecyclerAdapter != null) {
                ordersRecyclerAdapter.updateList(new Utils(getActivity())
                        .orderList(AppConstants.IN_KITCHEN_ORDER_STATUS,
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.fragment_in_kitchen_order, container, false);
