...
public class PrinterCommands {
    ...
    public static byte[] CUT_PAPER = {27, 100, 3, 51};
    public static byte[] ENABLE_RED_COLOR_PRINT = {27, 52};
    public static byte[] DISABLE_RED_COLOR_PRINT = {27, 53};
    public static byte[] ENABLE_COLOR_PRINT = {27, 30, 67, 1, 49};
    public static byte[] DISABLE_COLOR_PRINT = {27, 30, 67, 0, 48};
